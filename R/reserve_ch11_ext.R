...
#'
#' Additional Chapter 11 reserve functions:
#' FPT modified reserves, fractional-duration reserves,
#' gross premium reserves, expense reserves, and
...
#' computed sequentially, and the last component is taken as the
#' balancing item so that the components sum exactly to total gain.
#'
#' @param VtG Gross reserve at duration t.
#' @param Vt1G Gross reserve at duration t+1.
#' @param G Gross premium.
